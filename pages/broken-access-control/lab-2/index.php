                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php if ($current_user): ?>
                                    <div class="alert alert-info" role="alert">
                                        <h5>KTP:</h5>
                                        <p><img src="../../../uploads/identity/ktp_user_<?php echo htmlspecialchars(decrypt($current_user, $key)); ?>.jpg" alt=""></p>
                                    </div>
                                <?php else: ?>
                                    <div class="alert alert-danger" role="alert">
                                        KTP not found.
                                ...
                                <div class="mt-4">
                                    <h6>Quick Navigation:</h6>
                                    <a href="?user_id=<?php echo encrypt(1, $key) ?>" class="btn btn-outline-primary me-2">KTP User 1</a>
                                    <a href="?user_id=<?php echo encrypt(3, $key) ?>" class="btn btn-outline-primary me-2">KTP User 2</a>
                                    <a href="?user_id=<?php echo encrypt(5, $key) ?>" class="btn btn-outline-primary">KTP User 3</a>
                                </div>
                            </div>
                        </div>
                    </div>
